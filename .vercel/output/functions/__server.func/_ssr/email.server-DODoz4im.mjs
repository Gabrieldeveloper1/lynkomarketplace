//#region node_modules/.nitro/vite/services/ssr/assets/email.server-DODoz4im.js
function env(name) {
...
//#endregion
export { deliveryEmail, escapeEmailHtml, marketplaceEmail, sendTransactionalEmail };
