...
<html lang="pt-BR">
  ...
  <body>
    <div class="card">
      ...
      <p>Algo deu errado por aqui. Tente atualizar a página ou volte para o início.</p>
      <div class="actions">
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./server-935pLRdS.mjs").then((n) => n.t).then((m) => m.default ?? m);
