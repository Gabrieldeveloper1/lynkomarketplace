  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-12 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:py-20">
        ...
        <div className="mx-auto w-full max-w-md rounded-3xl border border-border bg-card/90 p-6 shadow-card backdrop-blur-xl sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              {mode === "recover"
                ? "Enviamos um link seguro para redefinir a senha."
                : "Entre na sua conta ou registe-se em segundos."}
            </p>
          </div>
          ...
          <div className="mt-6 flex items-center gap-2 rounded-xl border border-border bg-accent/40 p-3 text-[11px] text-muted-foreground">
            <Lock className="h-4 w-4 shrink-0 text-primary" aria-hidden />
            Conexão criptografada. Nunca compartilhamos seus dados com vendedores.
          </div>
