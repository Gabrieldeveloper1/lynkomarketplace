  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { name: "keywords", content: `${name}, produto digital, compra segura, LynkoMarketplace` },
      ...
      links: [
        { rel: "canonical", href: `https://www.lynkomarketplace.online/produto/${params.slug}` },
...
function ProdutoPage() {
  ...
  return (
    <div className="mx-auto min-w-0 max-w-7xl overflow-x-hidden px-3 pb-28 pt-4 sm:px-4 sm:pb-24 sm:pt-6 lg:pb-0">
      <script
      ...
      <div className="mt-4 grid min-w-0 gap-5 sm:mt-5 sm:gap-8 lg:grid-cols-[minmax(0,1fr)_380px]">
        <div className="min-w-0">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-primary/20 bg-primary/5 px-4 py-3 text-xs sm:px-5">
            <span className="flex items-center gap-2 font-semibold text-primary">
              <ShieldCheck className="h-4 w-4" /> Compra protegida pela Lynko
            </span>
            <span className="text-muted-foreground">Entrega e suporte acompanhados</span>
          </div>
          {/* Gallery */}
          ...
          {/* Tabs */}
          <Tabs defaultValue="descricao" className="mt-6 sm:mt-8">
            ...
            <TabsContent value="entrega">
              <div className="grid gap-3 rounded-2xl border border-border bg-card p-4 text-sm text-muted-foreground sm:p-5">
                <p>
        ...
        <aside className="h-fit lg:sticky lg:top-20">
          <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-card lg:max-w-none">
          ...
          {/* Seller */}
          <div className="mt-4 rounded-3xl border border-border bg-card p-4 sm:p-5">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
              Vendido por
            </p>
            <Link
