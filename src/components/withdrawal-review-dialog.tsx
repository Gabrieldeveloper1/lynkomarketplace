      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="grid gap-4">
          <div className="grid gap-2">
            <Label htmlFor="wr-reason">{approving ? "Motivo / observação" : "Motivo da recusa *"}</Label>
            <Textarea
              id="wr-reason"
              value={reason}
          ...
          <div className="grid gap-2">
            ...
            <Input id="wr-note" value={note} onChange={(e) => setNote(e.target.value)} placeholder="Resposta da equipe" />
          </div>
        </div>
